...
|-------|---------|-------|--------|
| H-001 | `dev-login` محمية بـ `NODE_ENV` فقط | `auth.service.ts:79` | BL-006 |
| H-002 | لا Refresh Token Rotation | `auth.service.ts:495` | BL-007 |
| H-003 | Treasurer يُنشئ القرارات ويُغلقها | `decisions.service.ts:45` | BL-008 |
| H-004 | نفس الشخص يعتمد وينفّذ الصرف | `disbursement-requests.service.ts` | BL-009 |
| H-005 | المطرود يصوّت على طرد نفسه | `decisions.service.ts:748` | BL-010 |
