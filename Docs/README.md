...
**الحالة الحالية:** الإصدار التشغيلي `2.10` بتاريخ 2026-07-01.
...
| Improvement 09 | Phase A وB وC منفذة؛ Phase D أغلقت default switch في D-011؛ Phase E بدأت في E-001 |
| أول عمل مفتوح | E-002: labels ديناميكية بين صندوق/حملة في الشاشات المشتركة |
