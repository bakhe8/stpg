...
**الحالة الحالية:** الإصدار التشغيلي `2.27` بتاريخ 2026-07-02.
...
| [20_POST_PHASE_G_POLISH_BACKLOG.md](09_Improvement/20_POST_PHASE_G_POLISH_BACKLOG.md) | backlog polish بعد Phase G: `PGP-001` إلى `PGP-003` منفذة؛ التالي `PGP-004` |
...
| أول عمل مرشح | `PGP-004`: Docker Frontend Readiness Check |
