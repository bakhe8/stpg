...
- الحالة العامة للمستودع مثبتة في `Docs/REPOSITORY_STATE.md` كإصدار تشغيلي `2.12`.
...
- العمل التالي E-004: مراجعة نصوص الشروط والخصوصية قانونياً بعد تثبيت لغة صندوق/حملة.
