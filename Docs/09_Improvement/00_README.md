...
- الحالة العامة للمستودع مثبتة في `Docs/REPOSITORY_STATE.md` كإصدار تشغيلي `2.10`.
...
- العمل التالي E-002: جعل الشاشات المشتركة تعرض `حملة` عندما يكون `isCampaign=true`، و`صندوق` خلاف ذلك.
