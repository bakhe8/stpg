...
NEXT_PUBLIC_ENABLE_FUND_CREATE_FLOW=true
```
...
مسار إنشاء الصندوق/الحملة الجديد هو الافتراضي. استخدم `NEXT_PUBLIC_ENABLE_FUND_CREATE_FLOW=false` فقط كمسار rollback مؤقت لإظهار النموذج القديم.
