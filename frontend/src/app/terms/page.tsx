      ...
      <div className={styles.content}>
        ...
        <div className={styles.section}>
          ...
          <p className={styles.sectionText}>
            CollectiveTrustOS منصة إلكترونية لإدارة الصناديق الجماعية والحملات التعاونية،
            تُتيح إدارة الأعضاء والمدفوعات والقرارات وسجلات التدقيق. الخدمة موجّهة للصناديق والحملات
            المرخّصة أو غير الرسمية التي تحتاج إلى حوكمة منظّمة وشفافة، ولا يُعد استخدام المنصة
            ترخيصاً أو تأسيساً لجهة قانونية.
          </p>
        </div>
        ...
        <div className={styles.section}>
          ...
          <ul className={styles.list}>
            <li>إدارة الصناديق العائلية والقبلية والتعاونيات والحملات</li>
        ...
        <div className={styles.section}>
          <h2 className={styles.sectionTitle}>٤. مسؤولية الصناديق والحملات والمستخدمين</h2>
          <p className={styles.sectionText}>
            كل صندوق أو حملة مسؤول عن البيانات التي يُدخلها والقرارات التي يتخذها داخل المنصة.
            المنصة أداة تنظيمية ولا تنشئ صفة اعتبارية أو ترخيصاً رسمياً لأي صندوق أو حملة،
            ولا تتحمّل مسؤولية النزاعات المالية بين الأعضاء. يتحمّل المؤسس مسؤولية الإدارة
        ...
        <div className={styles.section}>
          ...
          <p className={styles.sectionText}>
            ...
            لـ CollectiveTrustOS. البيانات التي تُدخلها تبقى ملكاً لك ولصندوقك أو حملتك.
          </p>
        </div>
        ...
        <div className={styles.section}>
          ...
          <ul className={styles.list}>
            <li>نحتفظ بحق تعليق أو إنهاء أي حساب أو صندوق أو حملة يخالف هذه الشروط</li>
