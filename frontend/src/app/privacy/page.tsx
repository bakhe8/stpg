    ...
    <div className={styles.page}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.section}>
          ...
          <ul className={styles.list}>
            <li><strong>مسؤولو الصندوق أو الحملة التي تنتمي إليها:</strong> يرون بيانات العضوية الضرورية للإدارة وفق الدور وسياسة الشفافية</li>
        ...
        <div className={styles.section}>
          ...
          <ul className={styles.list}>
            ...
            <li>صلاحيات محدودة بالدور داخل كل صندوق أو حملة — كل مستخدم يصل لما يخصّه فقط</li>
          </ul>
        </div>
